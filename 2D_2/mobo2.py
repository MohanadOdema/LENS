...
import os
import time
import CNN_alex, CNN_VGG_CIFAR        
import math
from translate import translate
import energy_latency_vgg2 as energy_latency_vgg
...
def evaluate(x, obj):
  ...
  edge_latency, edge_energy, index_latency, index_energy, values_latency, values_energy = energy_latency_vgg.evaluate(x, tu, technology)
  print(edge_latency)
  print(edge_energy)
  print(index_energy)
  print(values_energy)
